...
//            boxes[i] = new bin.Box((int) (Math.random() * ((max - min) + 1)) + min);
        boxes[0] = new Box(10);
        boxes[1] = new Box(10);
        boxes[2] = new Box(5);
        boxes[3] = new Box(10);
